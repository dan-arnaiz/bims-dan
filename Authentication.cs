    ...
    internal class Authentication
    {
        ...
        public bool SignUp(string username, string Email, string password)
        {
            ...
            using (var connection = new SqlConnection(connectionString))
            {
                ...
                var query = "INSERT INTO SystemUsers (Username, Email, PasswordHash, IsActive, CreatedAt) VALUES (@Username, @Email, @PasswordHash, 1, GETDATE())";
        ...
        private bool UserExists(string username, string Email)
        {
            ...
            {
                connection.Open();
                var query = "SELECT COUNT(1) FROM SystemUsers WHERE Username = @Username OR Email = @Email";
